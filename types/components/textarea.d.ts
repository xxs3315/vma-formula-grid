...
export interface VmaFormulaGridCompTextareaConstructor extends VmaComponentInstance, VmaFormulaGridCompTextareaMethods {
...
export type VmaFormulaGridCompTextareaEmits = ['update:modelValue', 'input', 'change', 'focus', 'blur', 'keydown', 'keyup'];
