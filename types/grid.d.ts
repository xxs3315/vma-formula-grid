...
export interface VmaFormulaGridConstructor
...
declare module "./grid" {
	interface VmaFormulaGridMethods
		extends VmaFormulaGridCompContextMenuMethods {}
	interface VmaFormulaGridPrivateMethods
		extends VmaFormulaGridCompContextMenuPrivateMethods {}
}
...
export interface VmaFormulaGridHeaderConstructor
	extends VmaComponentInstance,
...
export interface VmaFormulaGridBodyConstructor
	extends VmaComponentInstance,
