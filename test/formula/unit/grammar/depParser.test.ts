...
describe('dependency parser', () => {
  ...
  it('should parse basic formulas', () => {
    ...
    expect(actual).toStrictEqual([{ sheet: 'Sheet1', row: 1, col: 1 }])
    ...
    expect(actual).toStrictEqual([{ sheet: 'Sheet1', row: 3, col: 1 }])
  ...
  it('should not throw error', () => {
    expect(() => depParser.parse('SUM(1))', position, true)).not.toThrow()
