...
<p style="border-bottom: 1px solid black"><vma-formula-grid-comp-icon name="bookmark" size="normal" type="default" />ABC</p>
<p style="border-bottom: 1px solid black"><vma-formula-grid-comp-icon name="bookmark" size="large" type="default" />ABC</p>
