	...
	setup(props, context) {
		...
		onBeforeUnmount(() => {
			...
			if (
				...
				refGridBodyLeftFixedScrollWrapperDiv.value
			) {
				refGridBodyLeftFixedScrollWrapperDiv.value.onscroll = null;
			}
		});
				...
				props.fixed === "center"
					? [
							...
							h(TextareaComponent, {
								...
								style: {
									display:
										$vmaFormulaGrid.reactiveData.currentCellEditorStyle.display,
									transform:
										$vmaFormulaGrid.reactiveData.currentCellEditorStyle
											.transform,
									height:
										$vmaFormulaGrid.reactiveData.currentCellEditorStyle.height,
									width:
										$vmaFormulaGrid.reactiveData.currentCellEditorStyle.width,
									left: $vmaFormulaGrid.reactiveData.currentCellEditorStyle
										.left,
							...
							h("div", {
								...
								style: {
									transform:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle
											.transform,
									left: $vmaFormulaGrid.reactiveData.currentCellBorderStyle
										.left,
									top: $vmaFormulaGrid.reactiveData.currentCellBorderStyle.top,
									height:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.height,
									display:
										$vmaFormulaGrid.reactiveData.currentCell &&
										Object.keys($vmaFormulaGrid.reactiveData.currentCell)
											.length > 0
											? "none"
											: "none",
								},
							...
							h("div", {
								...
								style: {
									...
									top: $vmaFormulaGrid.reactiveData.currentCellBorderStyle.top,
									width:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.width,
									display:
										$vmaFormulaGrid.reactiveData.currentCell &&
										Object.keys($vmaFormulaGrid.reactiveData.currentCell)
											.length > 0
								...
								style: {
									transform:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle
											.transform,
									left:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.left +
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.width,
									top: $vmaFormulaGrid.reactiveData.currentCellBorderStyle.top,
									height:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.height,
							...
							h("div", {
								...
								style: {
									...
									left: $vmaFormulaGrid.reactiveData.currentCellBorderStyle
										.left,
									top:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.top +
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.height,
									width:
										$vmaFormulaGrid.reactiveData.currentCellBorderStyle.width,
									display:
								...
								style: {
									transform:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle
											.transform,
									left: $vmaFormulaGrid.reactiveData.currentAreaBorderStyle
										.left,
									top: $vmaFormulaGrid.reactiveData.currentAreaBorderStyle.top,
									height:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.height,
									display:
							...
							h("div", {
								...
								style: {
									...
									top: $vmaFormulaGrid.reactiveData.currentAreaBorderStyle.top,
									width:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.width,
									display:
										$vmaFormulaGrid.reactiveData.currentArea &&
										$vmaFormulaGrid.reactiveData.currentArea.start !== null &&
										$vmaFormulaGrid.reactiveData.currentArea.end !== null
								...
								style: {
									transform:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle
											.transform,
									left:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.left +
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.width,
									top: $vmaFormulaGrid.reactiveData.currentAreaBorderStyle.top,
									height:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.height,
							...
							h("div", {
								...
								style: {
									...
									left: $vmaFormulaGrid.reactiveData.currentAreaBorderStyle
										.left,
									top:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.top +
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.height,
									width:
										$vmaFormulaGrid.reactiveData.currentAreaBorderStyle.width,
									display:
					...
					? h(
							"div",
							{
								...
								style: {
									height: `${
										$vmaFormulaGrid.reactiveData.gridBodyHeight -
										$vmaFormulaGrid.reactiveData.scrollbarHeight
									}px`,
								},
							},
							[
		...
		const resizeRowMousedown = (event: MouseEvent) => {
			...
			const rowHeight = getRenderDefaultRowHeight(
				$vmaFormulaGrid.props.defaultRowHeight,
			...
			resizeBarElem.style.top = `${
				pos.top +
				refGridHeaderTableWrapperDiv.value.clientHeight +
				dragBtnOffsetHeight +
				topSpaceHeight
			}px`;
			...
			const updateEvent = (event: MouseEvent) => {
				...
				resizeBarElem.style.top = `${
					dragTop + refGridHeaderTableWrapperDiv.value.clientHeight
				}px`;
			};
			...
			document.onmouseup = () => {
				...
				if (dragBtnElem.parentElement!.getAttribute("data-row")) {
					const rowConfig = $vmaFormulaGrid.reactiveData.rowConfs.find(
						(item) =>
							item.index ===
							parseInt(
								dragBtnElem.parentElement!.getAttribute("data-row")!,
								10,
							),
					);
					if (rowConfig) {
						rowConfig.height = Math.max(
						...
						$vmaFormulaGrid.reactiveData.gridHeight +=
							rowConfig.height - rowHeight;
					}
				}
		...
		const mousemoveHandler = (event: MouseEvent) => {
			...
			if (eventTargetNode && eventTargetNode.flag) {
				...
				if (
					$vmaFormulaGrid.reactiveData.currentArea.end === null ||
					!(
						$vmaFormulaGrid.reactiveData.currentArea.end.row ===
							Number(targetElem.attributes["data-row"].value) &&
						$vmaFormulaGrid.reactiveData.currentArea.end.col ===
							Number(targetElem.attributes["data-col"].value)
					)
				) {
					$vmaFormulaGrid.reactiveData.currentArea.end =
						$vmaFormulaGrid.reactiveData.currentSheetData[
							Number(targetElem.attributes["data-row"].value)
						][Number(targetElem.attributes["data-col"].value) + 1];
					$vmaFormulaGrid.reCalcCurrentAreaPos();
					$vmaFormulaGrid.updateCurrentAreaStyle();
				}
			}
		...
		const renderBodyRows = () => {
			const trs: any = [];
			for (
				let index = $vmaFormulaGrid.reactiveData.yStart;
				index <= $vmaFormulaGrid.reactiveData.yEnd;
				index++
			) {
						...
						h(
							...
							[
								...
								$vmaFormulaGrid.props.rowResizable
									...
									: createCommentVNode(),
								$vmaFormulaGrid.reactiveData.rowHidesChanged &&
								Object.keys($vmaFormulaGrid.reactiveData.rowHidesChanged)
									.length > 0 &&
								$vmaFormulaGrid.reactiveData.rowHidesChanged.hasOwnProperty(
									`${rf.index}`,
								)
									? h(
											"div",
											{
												...
												onClick: (event: MouseEvent) => {
													...
													const rowHideInfoUpwardTargetNode =
									...
									? h(
											"div",
											{
												...
												onClick: (event: MouseEvent) => {
													event.stopPropagation();
													const refGridDivElem = refGridDiv.value;
													const rowHideInfoDownwardTargetNode =
														DomTools.getEventTargetNode(
															event,
															refGridDivElem,
													...
													if (rowHideInfoDownwardTargetNode.flag) {
														const elem =
															rowHideInfoDownwardTargetNode.targetElem;
														const targetElem: any = elem.parentElement!;
														$vmaFormulaGrid.updateRowVisible(
															"showDownRows",
															targetElem.attributes["data-row"].value,
				...
				if (props.fixed === "center") {
					for (
						let indexCol = $vmaFormulaGrid.reactiveData.xStart;
						indexCol <= $vmaFormulaGrid.reactiveData.xEnd;
						indexCol++
					) {
						...
						if (indexCol === -1) {
							...
							const cf: any =
								$vmaFormulaGrid.reactiveData.colConfs[indexCol + 1];
							if (
								!checkCellInMerges(
									cf.index + 1,
									rf.index + 1,
								...
								const cell =
									$vmaFormulaGrid.reactiveData.currentSheetData[rf.index][
										cf.index + 1
									];
								cols.push(
									h(
										"td",
										{
											...
											onMousedown: (event: MouseEvent) => {
												if (event) {
													if (event.button === 0) {
														if (cf.index >= 0) {
															$vmaFormulaGrid.reactiveData.currentCellEditorActive =
																false;
															$vmaFormulaGrid.reactiveData.currentCell =
																$vmaFormulaGrid.reactiveData.currentSheetData[
																	rf.index
															...
															$vmaFormulaGrid.reactiveData.currentAreaStatus =
																true;
															$vmaFormulaGrid.reactiveData.currentArea = {
																start:
																	$vmaFormulaGrid.reactiveData.currentSheetData[
															...
															if (
																...
																if (
																	...
																	$vmaFormulaGrid.reactiveData.currentArea = {
																		start:
																			$vmaFormulaGrid.reactiveData
																				.currentSheetData[rf.index][
																				cf.index + 1
																			],
																		end: $vmaFormulaGrid.reactiveData
																			.currentSheetData[rf.index][cf.index + 1],
																	};
																}
															} else {
																$vmaFormulaGrid.reactiveData.currentCellEditorActive =
				...
				trs.push(
					h(
						"tr",
						{
							...
							style: {
								height: rf.visible
									? typeof rf.height === "string"
										? `${renderDefaultRowHeight.value}px`
										: `${rf.height}px`
									: 0,
							},
						},
		...
		const scrollEvent = (event: Event) => {
			if (props.fixed === "center") {
				refGridHeaderTableWrapperDiv.value.scrollLeft =
					refGridBodyTableWrapperDiv.value.scrollLeft;
				refGridBodyLeftFixedScrollWrapperDiv.value.scrollTop =
					refGridBodyTableWrapperDiv.value.scrollTop;
		...
		const $vmaFormulaGridBody = {
			...
			renderVN: renderVN,
		} as unknown as VmaFormulaGridBodyConstructor &
			VmaFormulaGridBodyMethods &
			VmaFormulaGridBodyPrivateMethods;
