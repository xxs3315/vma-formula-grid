import { ComponentOptions, createCommentVNode, defineComponent, h, inject, PropType, reactive, resolveComponent, nextTick } from 'vue';
                        ...
                        h('col', {
                            ...
                            style: {
                                width: $vmaFormulaGrid.reactiveData.colConfs[index + 1].visible
                                    ? typeof $vmaFormulaGrid.reactiveData.colConfs[index + 1].width === 'string'
                                        ? `${renderDefaultColWidth.value}px`
                                        : `${$vmaFormulaGrid.reactiveData.colConfs[index + 1].width}px`
                                    : '0px',
                            },
                        }),
                    );
