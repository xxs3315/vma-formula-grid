...
export default defineComponent({
	...
	props: {
		...
		modelValue: [
			String,
			Number,
		] as PropType<VmaFormulaGridCompTextareaPropTypes.ModelValue>,
		immediate: {
		...
		placeholder:
			String as PropType<VmaFormulaGridCompTextareaPropTypes.Placeholder>,
		maxlength: [
			String,
			Number,
		] as PropType<VmaFormulaGridCompTextareaPropTypes.Maxlength>,
		size: {
		...
		rows: {
			type: [
				String,
				Number,
			] as PropType<VmaFormulaGridCompTextareaPropTypes.Rows>,
			default: 2,
		},
		wrap: {
	...
	setup(props, context) {
		...
		} as unknown as VmaFormulaGridCompTextareaConstructor &
			VmaFormulaGridCompTextareaMethods;
