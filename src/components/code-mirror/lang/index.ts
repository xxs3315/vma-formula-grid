...
import { setLezerIdiom, TsupportedIdioms, setDecimalSeparator, TdecimalSeparator } from './tokens';
...
export function spreadsheet({ idiom = 'en-US', decimalSeparator = '.' }: Toptions = {}) {
    setLezerIdiom(idiom);
