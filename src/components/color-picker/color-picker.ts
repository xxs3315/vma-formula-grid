...
export default defineComponent({
	...
	setup(props, context) {
		...
		const VmaFormulaGridCompColorPickerPalette = resolveComponent(
			"VmaFormulaGridCompColorPickerPalette",
		) as ComponentOptions;
		const VmaFormulaGridCompColorPickerBoard = resolveComponent(
			"VmaFormulaGridCompColorPickerBoard",
		) as ComponentOptions;
		const VmaFormulaGridCompColorPickerHue = resolveComponent(
			"VmaFormulaGridCompColorPickerHue",
		) as ComponentOptions;
		const VmaFormulaGridCompColorPickerLightness = resolveComponent(
			"VmaFormulaGridCompColorPickerLightness",
		) as ComponentOptions;
		const VmaFormulaGridCompColorPickerDisplay = resolveComponent(
