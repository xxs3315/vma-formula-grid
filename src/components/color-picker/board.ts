import { computed, defineComponent, getCurrentInstance, h, nextTick, onMounted, provide, reactive, ref, watch } from 'vue';
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        provide('$vmaFormulaGridCompColorPickerBoard', $vmaFormulaGridCompColorPickerBoard);
